...
@Component({
  selector: 'recipe-breadcrumbs',
  templateUrl: 'recipe-breadcrumbs.component.html',
  styleUrls: ['./recipe-breadcrumbs.component.scss']
})
export class RecipeBreadcrumbsComponent implements OnInit {
  ...
  get lastBreadcrumb(): Breadcrumb | null {
